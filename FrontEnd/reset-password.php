...
<div class="container toparea">
	<div class="underlined-title">
		<div class="editContent">
			<h1 class="text-center latestitems">Reset Password</h1>
		</div>
	...
	<div class="row">
		<div class="col-lg-8 col-lg-offset-2">
            ...
            <div class="form-group">
                ...
                <input type="text" name="new_password" placeholder="New Password" <?php echo (!empty($new_password_err)) ? 'is-invalid' : ''; ?> value="<?php echo $new_password; ?>">
                <span class="invalid-feedback"><?php echo $new_password_err; ?></span>
            </div>
            <div class="form-group">
               
                <input type="password" name="confirm_password" placeholder="Confirm Password" <?php echo (!empty($confirm_password_err)) ? 'is-invalid' : ''; ?>>
